...
**Суурь зураг.** `IMAGE_MODEL`-ээр кино кадар/документари стилийн гэрэл зураг:
...
**Headline** (`fbHook`) — LLM 3 хувилбар бичиж, `checkHook` давсан **хамгийн богиныг** сонгоно:
110 тэмдэгтээс богино, нэг өгүүлбэр, **тоо баримттай**, баталгаатай өнгө, emoji/хашилт/хашгирахгүй.
