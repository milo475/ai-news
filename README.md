...
**Суурь зураг.** Сэдвийн **хүний талыг** харуулна (моделийн шахалт → утсан дээрээ AI ашиглаж буй
хүн; чип → гал тогооны ширээн дээрх зөөврийн компьютер) — лаборатори, дата төвийг зөвхөн нийтлэл
яг тэр тухай бол. Компози: гол объект **дээд 2/3-д**, доод 1/3 хоосон/харанхуй (ширээ, шал, хана)
