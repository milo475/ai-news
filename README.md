...
### Railway Console дээр гараар ажиллуулах

Railway-ийн **Console (SSH shell)** нь үйлчилгээний Variables-ыг өвлөдөггүй: тэнд
`npm run seed:tools` гэх мэтийг ажиллуулахад `OPENROUTER_API_KEY` хоосон болж, OpenRouter
**401** буцаана. Зөв арга нь:

```bash
railway run --service cron npm run seed:tools
```

Гэхдээ ингэж мартсан ч эвдрэхгүй: `src/lib/env.ts` нь шаардлагатай хувьсагч дутуу үед
**PID 1-ийн орчноос** (`/proc/1/environ`) нөхнө. Контейнер дотор PID 1 нь тухайн
үйлчилгээний өөрийнх нь процесс тул яг тэр хувьсагчид байна.

- зөвхөн Linux дээр, зөвхөн `DATABASE_URL`/`OPENROUTER_API_KEY`-ийн аль нэг дутуу үед
- **байгаа утгыг хэзээ ч дарж бичихгүй** (`.env` давуу)
- уншиж чадахгүй бол чимээгүй өнгөрнө — энэ нь тусламж болохоос баталгаа биш
- зөвхөн хувьсагчийн **нэрийг** хэвлэнэ, утгыг нь хэзээ ч биш

`src/db.ts` ба `src/agent/llm.ts` хоёр үүнийг өөрсдөө дууддаг тул бүх CLI скрипт хамрагдана.
Түлхүүр буруу байвал скрипт **эхний алдаан дээрээ зогсож** exit 1 өгнө (`src/lib/cli.ts`) —
80 удаа давтаж, хагас дутуу өгөгдөл DB-д бичихгүй.
...
> ⚠ Railway-ийн **Console (SSH shell)** дээр `npm run bench` гэж шууд бичиж болохгүй —
> тэр shell нь үйлчилгээний Variables-ыг өвлөдөггүй. `railway run` ашиглана уу.
> (Ийм үед код нь өөрөө PID 1-ээс env-ийг нөхөхийг оролдоно —
> [Railway Console дээр гараар ажиллуулах](#railway-console-дээр-гараар-ажиллуулах).)

**Run амжилтгүй болох нөхцөл.** Модель нэг ч даалгаварт хариу өгөөгүй бол дүгнэлт
гаргахгүй — «0.00/10» гэсэн хуурамч оноо жагсаалтад гарах ёсгүй. Бүх модель ингэвэл
run нь `FAILED` болж, `BenchModelSummary` ч, DRAFT нийтлэл ч **огт үүсэхгүй**, `JobRun`
нь `ok=false` болно. Түлхүүрийн алдаа (401/403) гарвал эхний даалгавар дээрээ зогсоно —
510 удаа дэмий оролдохгүй.

**Сарын үр дүнг устгах:**
...
`BenchRun` (`BenchResult`, `BenchModelSummary` нь cascade-аар хамт) болон уг run-ийн
автоматаар үүсгэсэн **DRAFT** нийтлэлийг устгана. Нийтлэгдсэн нийтлэлийг зориуд
хөндөхгүй — `--with-published` гэж зөвшөөрч л байж устгана.
