...
Нийтлэлийн хураангуйг **шууд хэрэглэхгүй**: `src/publish/fbcopy.ts` нь FB-д зориулж тусад нь бичүүлж
`Article.fbText`-д хадгална (/admin-аас гараар засаж болно).

```
<hook — See more-оос өмнө харагдах 1 мөр, 90 тэмдэгтээс богино>

<2–3 өгүүлбэр: яагаад чухал, уншигчид юу гэсэн үг>
...
Хэв маяг: мэргэжлийн сэтгүүлч, гэхдээ уншигчтайгаа кофе уугаад ярьж байгаа мэт. **Emoji байхгүй**,
хашилт/том үсгээр хашгирахгүй, «AI бичсэн» гэх мэт илчлэлт байхгүй, эх сурвалжийн нэр байхгүй.
Ангиллаар өнгө аяс өөрчлөгдөнө (`CATEGORY_TONE`): PROJECT/BUSINESS — «яаж хийсэн, давтаж болох уу»,
FACT — гайхшрал, RISK — тайван, айлгахгүй, HOWTO — алхам.

Нэг нийтлэлд **2 хувилбар** (өөр hook загвартай) бичүүлж, санамсаргүй нэгийг нь постлоод нөгөөг
`fbTextAlt`-д хадгална. Постлосон хувилбарын загвар `fbHookType`-д үлдэнэ — дараа нь аль нь
ажилладгийг харна. Hook-ийн 5 загвар (хамгийн цөөн хэрэглэснийг ээлжлэн сонгоно):
`number` (тоо/факт), `contrast` («...гэтэл»), `question` (уншигчид хандсан), `local` (Монгол/хүний
өнцөг), `forecast` (дараа юу болох).

Гарсан текстийг `checkPost` шалгана (emoji, hook урт, хашилт, хашгирах, AI-ийн илчлэлт, эх сурвалжийн
нэр, 400–700 тэмдэгт). Зөрчил гарвал алдааг нь хэлж нэг удаа дахин бичүүлээд, үлдсэнийг нь
механикаар цэвэрлэнэ (`sanitizeVariant`) — пост хэзээ ч зогсохгүй.

### Зураг
`src/publish/fbimage.ts` — 1080×1080 JPEG, `Article.fbImageData`-д (web ба cron тусдаа контейнер
учраас файлаар дамжуулах боломжгүй). /admin дээр `/api/fb-image/<id>` замаар харагдана.
...
**Өдөрт нэг удаагийн алхмууд.** Pipeline өдөрт 3 удаа ажилладаг тул `openrouter`, `arena`, `digest`,
`newsletter` алхмууд УБ цагаар тухайн өдөр амжилттай ажилласан бол дараагийн run-д «өнөөдөр
ажилласан» гэж алгасагдана (жагсаалт өдөрт нэг л удаа шинэчлэгддэг, digest Ням гарагт нэг удаа).
`rss` ба `agent` run бүрт ажиллана — зөвхөн шинэ RAW нийтлэлийг боловсруулдаг тул LLM-ийн зардал
нэмэгдэхгүй. `facebook` мөн run бүрт ажиллаж нэг пост тавина.

Гараар албадах бол `--only <алхам>` гэж нэрлэнэ (жишээ `npm run pipeline -- --only arena`) —
өдөрт нэг удаагийн шалгалт алгасагдана. `/admin`-ы товчнууд мөн үүгээр ажилладаг.

## Автоматжуулалт (cron) — өдөрт 3 удаа
```
0 1,5,11 * * *
```
UTC 01:00, 05:00, 11:00 = **Улаанбаатарын цагаар 09:00, 13:00, 19:00**. Run бүрт: шинэ мэдээ татаж,
агент бичиж, өдрийн квотын үлдэгдлийг нийтэлж, Facebook-т 1 пост тавина.

Локал (Kali):
```
0 1,5,11 * * * cd /home/kali/ai-medee && /usr/bin/npm run pipeline >> logs/pipeline.log 2>&1
```
